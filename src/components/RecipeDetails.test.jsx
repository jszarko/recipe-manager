...
describe('RecipeDetails', () => {
	...
	it('renders recipe name', async () => {
		...
		expect(
			screen.getByRole('heading', { name: 'Olive Oil Grape Cake' })
		).toBeInTheDocument();
	});
	...
	it('renders recipe image', async () => {
		...
		expect(screen.getByAltText('Olive Oil Grape Cake')).toBeInTheDocument();
	});
	...
	it('renders ingredients HTML', async () => {
		...
		expect(screen.getByTestId('fake-ingredients')).toBeInTheDocument();
	});
	...
	it('renders instructions HTML', async () => {
		...
		expect(screen.getByTestId('fake-instructions')).toBeInTheDocument();
	});
